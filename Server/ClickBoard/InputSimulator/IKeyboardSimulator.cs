...
namespace WindowsInput
{
    ...
    public interface IKeyboardSimulator
    {
        ...
        void ModifiersUp(InputBuilder builder, IEnumerable<VirtualKeyCode> modifierKeyCodes);

        void SendSimulatedInput(INPUT[] inputList);

        void KeysPress(InputBuilder builder, IEnumerable<VirtualKeyCode> keyCodes);

        void ModifiersDown(InputBuilder builder, IEnumerable<VirtualKeyCode> modifierKeyCodes);
    }
}
