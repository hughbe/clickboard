...
namespace WindowsInput
{
    ...
    public class KeyboardSimulator : IKeyboardSimulator
    {
        ...
        public void ModifiersDown(InputBuilder builder, IEnumerable<VirtualKeyCode> modifierKeyCodes)
        {
            if (modifierKeyCodes == null) return;
            foreach (var key in modifierKeyCodes) builder.AddKeyDown(key);
        }

        public void ModifiersUp(InputBuilder builder, IEnumerable<VirtualKeyCode> modifierKeyCodes)
        {
            if (modifierKeyCodes == null) return;
        ...
        public void KeysPress(InputBuilder builder, IEnumerable<VirtualKeyCode> keyCodes)
        {
        ...
        public void SendSimulatedInput(INPUT[] inputList)
        {
